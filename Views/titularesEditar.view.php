                ...
                <form action="titularesActualizarController.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="tipoPersona" name="tipoPersona" required>
                            <option value="<?= $razon->tipo ?>" selected><?= $razon->tipo ?></option>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="provincia" name="provincia" required>
                            ...
                            <option value="<?= $razon->provincia ?>" selected><?= $razon->provincia ?></option>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="estado" name="estado" required>
                                <option value="<?= $razon->estado ?>" selected><?= $razon->estado ?></option>
...
<script>
    ...
    document.getElementById('razonSocialForm').addEventListener('submit', function(e) {
        ...
        fetch('titularesActualizarController.php', {
                method: 'POST',
                body: formData
            })
            ...
            .then(data => {
                if (data.success) {
                    showAlert('Razón social actualizada correctamente.', 'success');
                    resetForm();
                } else {
